    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participants', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pig_info', to='app.participants')),
            ],
        ),
        migrations.CreateModel(
            name='Schedule',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='participants', to='app.profile'),
        ),
    ]
